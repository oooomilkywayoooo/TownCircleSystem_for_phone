...
INSERT INTO circulars (title, body, start_date, end_date) VALUES
('自治会費集金のお知らせ', '7月分の自治会費集金を行います。各組の組長が集金にお伺いしますので、期間内のお支払いにご協力をお願いします。', '2026-07-01', '2026-07-31'),
('資源ごみ回収カレンダー', '6月の資源ごみ回収予定日一覧です。缶・びん・ペットボトルは第2・第4水曜日、古紙は第1・第3金曜日です。', '2026-06-01', '2026-06-30'),
('防犯パトロールのお知らせ', '毎週土曜19時より町内防犯パトロールを実施しています。参加できる方は公民館前に集合してください。', '2026-05-01', '2026-05-31');
